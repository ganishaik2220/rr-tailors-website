...
// Auto-playing Ezgif Header Animation with Mobile Performance Safeguard
        ...
        if (headerCanvas) {
            if (isMobileDevice) {
                ...
                if (heroSection) {
                    heroSection.style.backgroundImage = "url('assets/images/products/hero/ezgif-frame-001.jpg')";
                ...
                for (let i = 1; i <= totalHeaderFrames; i++) {
                    const img = new Image();
                    img.src = `assets/images/products/hero/ezgif-frame-${i.toString().padStart(3, '0')}.jpg`;
                    img.onload = () => {
                        loadedHeaderFrames++;
